...
kubectl exec $hrclient -- /bin/bash -c "cd root && ./wrk -D $DIST -t 2 -c 100 -d 20 -L -s ${SOCIAL_DIR}/wrk2/scripts/social-network/compose-post.lua http://nginx-thrift.${NAMESPACE}.svc.cluster.local:8080/wrk2-api/post/compose -R 2000"
